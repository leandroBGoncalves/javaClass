package br.com.leandrogoncalves.todolist.task;
...
import br.com.leandrogoncalves.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        ...
        if (currentDate.isAfter(taskModel.getStartAt()) || currentDate.isAfter(taskModel.getEndAt())) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("StartAt / EndAt cannot be in the past");
        }
    ...
    public ResponseEntity update(@RequestBody TaskModel taskModel, HttpServletRequest request, @PathVariable UUID id) {
        ...
        var tasksUpdate = this.taskRepository.save(task);
